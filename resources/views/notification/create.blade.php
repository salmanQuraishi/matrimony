                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="col-md-12" style="padding: 10px">
                      <img width="100%"
                        src="{{asset('/add-img-placeholder.jpg')}}"
                        id="slider-preview">
                    </div>
                    <x-form-input type="file" id="image-slider" name="image" :value="old('image')" />
                  </div>
                  <div class="col-md-6">
                    <x-form-input type="text" id="nameInput" label="Title" name="title" :value="old('title')"
