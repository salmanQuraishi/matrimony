        ...
        <div class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <div class="card-title">Edit Complexion</div>
            </div>

            <form action="{{ route('complexion.update', $complexion->id) }}" method="post">
              @csrf
              @method('PUT')
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <x-form-input type="text" id="complexion_name" label="Complexion Title" name="name"
                      :value="old('name', $complexion->name)" placeholder="Enter Complexion Title" />

                    <x-form-input type="text" id="hindi_name" label="Complexion Hindi Title" name="hindi_name"
                      :value="old('hindi_name', $complexion->hindi_name)" readonly
                      placeholder="Hindi title auto generated" />

                    <x-status-select id="statusSelect" name="status" :selected="old('status', $complexion->status)" />
